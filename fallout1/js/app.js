// Fallout 1 Interactive Map - Main Application
...
class FalloutMapApp {
    ...
    savePreferences() {
        localStorage.setItem('fo1map_prefs', JSON.stringify(Array.from(this.visibleCategories)));
    }

    loadPreferences() {
        try {
            const stored = localStorage.getItem('fo1map_prefs');
            if (stored) {
