// Fallout 1 Map Engine - Canvas-based with actual game map
...
class MapEngine {
    constructor(canvasId) {
        ...
        // Viewport state
        this.viewport = { x: 0, y: 0, zoom: 1, minZoom: 0.5, maxZoom: 4 };
