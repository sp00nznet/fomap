...
// Map shows: Military Base (far left), Vault 13 (center-top), Shady Sands (right-top),
// Vault 15 (far right), Raiders, Brotherhood (left-center), Junktown (center),
// Necropolis (right-middle), The Hub (center), Boneyard (center-lower),
// Cathedral (lower-left), The Glow (far right-lower)
const locations = [
    // === VAULTS ===
    { id: 1, name: 'Vault 13', category: 'vaults', x: 0.42, y: 0.12,
    ...
    { id: 2, name: 'Vault 15', category: 'vaults', x: 0.92, y: 0.08,
    ...
    { id: 3, name: 'Vault 12 (Necropolis)', category: 'vaults', x: 0.82, y: 0.42,
    ...
    // === MAJOR TOWNS ===
    { id: 10, name: 'Shady Sands', category: 'towns', x: 0.78, y: 0.08,
    ...
    { id: 11, name: 'Junktown', category: 'towns', x: 0.52, y: 0.38,
    ...
    { id: 12, name: 'The Hub', category: 'towns', x: 0.42, y: 0.48,
    ...
    { id: 13, name: 'Necropolis', category: 'towns', x: 0.82, y: 0.42,
    ...
    { id: 14, name: 'Boneyard', category: 'towns', x: 0.45, y: 0.62,
    ...
    { id: 15, name: 'Adytum', category: 'towns', x: 0.43, y: 0.64,
    ...
    // === MILITARY ===
    { id: 20, name: 'Mariposa Military Base', category: 'military', x: 0.12, y: 0.15,
    ...
    { id: 21, name: 'The Glow (West Tek)', category: 'military', x: 0.85, y: 0.72,
    ...
    // === FACTION HQ ===
    { id: 30, name: 'Lost Hills Bunker', category: 'faction', x: 0.30, y: 0.38,
    ...
    { id: 31, name: 'The Cathedral', category: 'faction', x: 0.38, y: 0.72,
    ...
    { id: 32, name: 'LA Vault (Master\'s Lair)', category: 'faction', x: 0.38, y: 0.74,
    ...
    // === RAIDER CAMPS ===
    { id: 40, name: 'Khan Base', category: 'raiders', x: 0.80, y: 0.18,
    ...
    // === CAVES & RUINS ===
    { id: 50, name: 'Radscorpion Caves', category: 'caves', x: 0.75, y: 0.12,
    ...
    { id: 51, name: 'Hub Underground', category: 'caves', x: 0.43, y: 0.49,
      description: 'The thieves guild operates in tunnels beneath the Hub. Loxley leads the underground criminal network.' },
    { id: 52, name: 'Followers Library', category: 'caves', x: 0.44, y: 0.65,
    ...
    { id: 53, name: 'Gun Runners Fortress', category: 'caves', x: 0.48, y: 0.60,
    ...
    // === SPECIAL ENCOUNTERS (Random locations - approximate) ===
    ...
    { id: 61, name: 'Crashed UFO', category: 'special', x: 0.60, y: 0.30,
      description: 'Special encounter: An alien spacecraft crash site. Contains the alien blaster and power cells.' },
    { id: 62, name: 'Bob\'s Pre-Owned Car Mart', category: 'special', x: 0.55, y: 0.25,
