...
const locations = [
    // === MAJOR SETTLEMENTS ===
    { id: 1, name: 'Sanctuary Hills', category: 'settlements', x: 0.22, y: 0.12,
    ...
    { id: 2, name: 'Diamond City', category: 'settlements', x: 0.45, y: 0.58,
    ...
    { id: 3, name: 'Goodneighbor', category: 'settlements', x: 0.52, y: 0.52,
    ...
    { id: 4, name: 'Bunker Hill', category: 'settlements', x: 0.55, y: 0.42,
    ...
    { id: 5, name: 'The Castle', category: 'settlements', x: 0.72, y: 0.72,
    ...
    { id: 10, name: 'The Institute', category: 'faction', x: 0.48, y: 0.55,
    ...
    { id: 21, name: 'Vault 81', category: 'vaults', x: 0.35, y: 0.55,
    ...
    { id: 22, name: 'Vault 75', category: 'vaults', x: 0.50, y: 0.28,
    ...
    { id: 23, name: 'Vault 95', category: 'vaults', x: 0.28, y: 0.92,
    ...
    { id: 24, name: 'Vault 114', category: 'vaults', x: 0.48, y: 0.55,
    ...
    { id: 81, name: 'Rocky Cave', category: 'dungeons', x: 0.20, y: 0.92,
...
const collectibles = {
    bobbleheads: [
        { id: 'bb_str', name: 'Strength Bobblehead', x: 0.48, y: 0.52, location: 'Mass Fusion Building', description: 'On a statue overlooking the lobby.' },
        { id: 'bb_per', name: 'Perception Bobblehead', x: 0.28, y: 0.20, location: 'Museum of Freedom', description: 'On Preston\'s desk.' },
        { id: 'bb_end', name: 'Endurance Bobblehead', x: 0.32, y: 0.55, location: 'Poseidon Energy', description: 'In the central metal hut.' },
        { id: 'bb_cha', name: 'Charisma Bobblehead', x: 0.45, y: 0.22, location: 'Parsons State Insane Asylum', description: 'Jack Cabot\'s office.' },
        { id: 'bb_int', name: 'Intelligence Bobblehead', x: 0.42, y: 0.58, location: 'Boston Public Library', description: 'On the computer bank.' },
        { id: 'bb_agi', name: 'Agility Bobblehead', x: 0.82, y: 0.68, location: 'Wreck of FMS Northern Star', description: 'On the bow of the ship.' },
        { id: 'bb_lck', name: 'Luck Bobblehead', x: 0.78, y: 0.82, location: 'Spectacle Island', description: 'In a locker on a boat.' },
        { id: 'bb_barter', name: 'Barter Bobblehead', x: 0.78, y: 0.30, location: 'Longneck Lukowski\'s Cannery', description: 'On the metal catwalk.' },
        { id: 'bb_bigguns', name: 'Big Guns Bobblehead', x: 0.28, y: 0.92, location: 'Vault 95', description: 'In the living quarters.' },
        { id: 'bb_energy', name: 'Energy Weapons Bobblehead', x: 0.18, y: 0.52, location: 'Fort Hagen Command Center', description: 'On a table in the kitchen.' },
        { id: 'bb_explosives', name: 'Explosives Bobblehead', x: 0.68, y: 0.25, location: 'Saugus Ironworks', description: 'On a control panel.' },
        { id: 'bb_lockpick', name: 'Lock Picking Bobblehead', x: 0.55, y: 0.45, location: 'Pickman Gallery', description: 'In the final tunnel.' },
        { id: 'bb_medicine', name: 'Medicine Bobblehead', x: 0.35, y: 0.55, location: 'Vault 81', description: 'In Curie\'s chamber.' },
        { id: 'bb_melee', name: 'Melee Bobblehead', x: 0.45, y: 0.52, location: 'Trinity Tower', description: 'At the top with Strong.' },
        { id: 'bb_repair', name: 'Repair Bobblehead', x: 0.52, y: 0.30, location: 'Corvega Assembly Plant', description: 'On the southwest roof.' },
        { id: 'bb_science', name: 'Science Bobblehead', x: 0.50, y: 0.28, location: 'Vault 75', description: 'On the desk in the science lab.' },
        { id: 'bb_smallguns', name: 'Small Guns Bobblehead', x: 0.50, y: 0.65, location: 'Gunners Plaza', description: 'On the broadcast desk.' },
        { id: 'bb_sneak', name: 'Sneak Bobblehead', x: 0.72, y: 0.18, location: 'Dunwich Borers', description: 'On a desk by Area 4 sign.' },
        { id: 'bb_speech', name: 'Speech Bobblehead', x: 0.48, y: 0.55, location: 'Vault 114', description: 'In the Overseer\'s office.' },
        { id: 'bb_unarmed', name: 'Unarmed Bobblehead', x: 0.58, y: 0.82, location: 'Atom Cats Garage', description: 'On the hood of the car.' }
    ]
};
