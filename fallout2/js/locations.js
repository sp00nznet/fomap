...
// Coordinates based on actual Fallout 2 world map (green markers visible)
const locations = [
    ...
    // === NORTHERN TOWNS ===
    { id: 2, name: 'Klamath', category: 'towns', x: 0.15, y: 0.12,
    ...
    { id: 60, name: 'Toxic Caves', category: 'caves', x: 0.12, y: 0.14,
    ...
    { id: 3, name: 'The Den', category: 'towns', x: 0.22, y: 0.22,
    ...
    { id: 4, name: 'Modoc', category: 'towns', x: 0.42, y: 0.15,
    ...
    { id: 62, name: 'Ghost Farm', category: 'special', x: 0.44, y: 0.13,
    ...
    { id: 6, name: 'Gecko', category: 'towns', x: 0.52, y: 0.18,
    ...
    { id: 50, name: 'Gecko Power Plant', category: 'industrial', x: 0.53, y: 0.17,
    ...
    { id: 5, name: 'Vault City', category: 'towns', x: 0.58, y: 0.22,
    ...
    { id: 20, name: 'Vault 8', category: 'vaults', x: 0.59, y: 0.23,
    ...
    // === CENTRAL REGION ===
    { id: 9, name: 'Redding', category: 'towns', x: 0.32, y: 0.42,
    ...
    { id: 51, name: 'Great Wanamingo Mine', category: 'industrial', x: 0.30, y: 0.40,
    ...
    { id: 7, name: 'Broken Hills', category: 'towns', x: 0.72, y: 0.42,
    ...
    // === NEW RENO AREA ===
    { id: 8, name: 'New Reno', category: 'towns', x: 0.48, y: 0.45,
    ...
    // === VAULT 13 REGION ===
    { id: 21, name: 'Vault 13', category: 'vaults', x: 0.28, y: 0.55,
    ...
    { id: 33, name: 'Mariposa Military Base', category: 'military', x: 0.22, y: 0.58,
    ...
    { id: 65, name: 'New Khans Camp', category: 'tribal', x: 0.35, y: 0.62,
    ...
    { id: 10, name: 'NCR (Shady Sands)', category: 'towns', x: 0.55, y: 0.68,
    ...
    { id: 40, name: 'NCR Bazaar', category: 'faction', x: 0.56, y: 0.69,
      description: 'The commercial heart of NCR. Home to shops, the Rangers, and political intrigue.' },
    { id: 11, name: 'Vault 15', category: 'vaults', x: 0.58, y: 0.65,
    ...
    // === COASTAL REGION (West) ===
    { id: 30, name: 'Navarro', category: 'military', x: 0.08, y: 0.75,
    ...
    { id: 12, name: 'San Francisco', category: 'towns', x: 0.18, y: 0.82,
