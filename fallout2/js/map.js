// Fallout 2 Map Engine - Canvas-based with actual game map
...
class MapEngine {
    ...
    render() {
        ...
        ctx.drawImage(this.mapImage, this.viewport.x, this.viewport.y, this.mapWidth * this.viewport.zoom, this.mapHeight * this.viewport.zoom);
        this.renderMarkers();
    }
